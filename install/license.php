...
<div class="block_button">
		<input name="Button2" type="button" class="submit" value="Précédent" onclick="window.location='index.php';" />
		<input name="Button2" type="button" class="submit" value="Suivant" onclick="window.location='install1.php';" />
</div>
<?php
